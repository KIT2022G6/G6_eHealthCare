package edu.multicampus.eHealthCare.security.services;
...
import edu.multicampus.eHealthCare.repository.RefreshTokenRepository;
import edu.multicampus.eHealthCare.repository.UserRepository;
@Service
public class RefreshTokenService {
  @Value("${multicampus.edu.jwtRefreshExpirationMs}")
